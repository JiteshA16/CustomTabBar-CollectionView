...
class SHCircleBarController: UITabBarController {
    ...
    open override func viewDidLoad() {
        ...
        circleView.backgroundColor = UIColor(red: 236/255, green: 236/255, blue: 236/255, alpha: 1.0)
        circleView.isUserInteractionEnabled = false
        circleView.addShadowToAll()
    ...
    override func viewDidLayoutSubviews() {
        ...
        circleView.frame = CGRect(x: (tabWidth * CGFloat(selectedIndex) + tabWidth / 2 - 30), y: self.tabBar.frame.origin.y - 20, width: 60, height: 60)
    ...
    private var _barHeight: CGFloat = 68
    ...
    private func createShadowLayer(shadowColor: UIColor, alpha: CGFloat) -> CALayer {
